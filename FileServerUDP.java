    ...
    public static void main(String[] args) { 
        ...
        try { 
            ...
            if (file.exists() && !file.isDirectory()) { 
                ...
                DatagramPacket confirmationPacket = new DatagramPacket(response, response.length, 
clientAddress, clientPort); 
                ...
                while ((bytesRead = bis.read(fileBuffer)) != -1) { 
                    DatagramPacket filePacket = new DatagramPacket(fileBuffer, bytesRead, clientAddress, 
clientPort); 
                ...
                DatagramPacket errorPacket = new DatagramPacket(response, response.length, clientAddress, 
clientPort); 
